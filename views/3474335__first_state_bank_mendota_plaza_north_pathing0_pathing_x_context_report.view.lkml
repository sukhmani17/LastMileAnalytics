# The name of this view in Looker is "3474335 First State Bank Mendota Plaza North Pathing0 Pathing X Context Report"
view: 3474335__first_state_bank_mendota_plaza_north_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3474335_ First_State_Bank_MendotaPlazaNorth_Pathing-0_pathing_x_context_report` ;;
