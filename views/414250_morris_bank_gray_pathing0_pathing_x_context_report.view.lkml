# The name of this view in Looker is "414250 Morris Bank Gray Pathing0 Pathing X Context Report"
view: 414250_morris_bank_gray_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.414250_MorrisBank_Gray_Pathing-0_pathing_x_context_report` ;;
