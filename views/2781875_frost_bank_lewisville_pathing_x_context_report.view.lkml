# The name of this view in Looker is "2781875 Frost Bank Lewisville Pathing X Context Report"
view: 2781875_frost_bank_lewisville_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.2781875_Frost_Bank_Lewisville_pathing_x_context_report` ;;
