# The name of this view in Looker is "3509324 Nano Blanc Murrieta Ca Pathing0 Pathing X Context Report"
view: 3509324_nano_blanc_murrieta_ca_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3509324_NanoBlanc_Murrieta_CA_Pathing-0_pathing_x_context_report` ;;
