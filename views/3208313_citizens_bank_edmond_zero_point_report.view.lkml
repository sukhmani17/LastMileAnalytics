# The name of this view in Looker is "3208313 Citizens Bank Edmond Zero Point Report"
view: 3208313_citizens_bank_edmond_zero_point_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3208313_CitizensBank_EDMOND_zero_point_report` ;;
