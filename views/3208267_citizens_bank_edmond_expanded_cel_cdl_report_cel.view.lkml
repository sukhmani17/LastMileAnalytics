# The name of this view in Looker is "3208267 Citizens Bank Edmond Expanded Cel Cdl Report Cel"
view: 3208267_citizens_bank_edmond_expanded_cel_cdl_report_cel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3208267_CitizensBank_EDMOND_expanded_cel_cdl_report_cel` ;;
