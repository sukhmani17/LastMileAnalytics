# The name of this view in Looker is "3373003 First Keystone Bank Berwick Pa Pathing X Context Report"
view: 3373003_first_keystone_bank_berwick_pa_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3373003_FirstKeystoneBank_Berwick_PA_pathing_x_context_report` ;;
