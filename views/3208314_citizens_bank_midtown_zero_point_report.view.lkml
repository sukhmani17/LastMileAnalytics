# The name of this view in Looker is "3208314 Citizens Bank Midtown Zero Point Report"
view: 3208314_citizens_bank_midtown_zero_point_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3208314_CitizensBank_Midtown_zero_point_report` ;;
