# The name of this view in Looker is "2781875 Frost Bank Lewisville Expanded Cel Cdl Report Cel"
view: 2781875_frost_bank_lewisville_expanded_cel_cdl_report_cel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.2781875_Frost_Bank_Lewisville_expanded_cel_cdl_report_cel` ;;
