# The name of this view in Looker is "3391086 Oconee State Bank Watkinsville Pathing0 Pathing X Context Report"
view: 3391086_oconee_state_bank_watkinsville_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3391086_Oconee_State_Bank_Watkinsville_Pathing-0_pathing_x_context_report` ;;
