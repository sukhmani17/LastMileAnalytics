# The name of this view in Looker is "2745888 Wells Fargo Bank Kingston Pathing X Context Report"
view: 2745888_wells_fargo_bank_kingston_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.2745888_WellsFargoBank_Kingston_pathing_x_context_report` ;;
