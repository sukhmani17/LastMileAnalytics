# The name of this view in Looker is "3208278 Citizens Bank Midtown Pathing X Context Report"
view: 3208278_citizens_bank__midtown_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3208278_CitizensBank__MIDTOWN_pathing_x_context_report` ;;
