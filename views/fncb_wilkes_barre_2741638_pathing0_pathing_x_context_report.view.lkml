# The name of this view in Looker is "Fncb Wilkes Barre 2741638 Pathing0 Pathing X Context Report"
view: fncb_wilkes_barre_2741638_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.fncb_wilkes_barre_2741638_Pathing-0_pathing_x_context_report` ;;
