# The name of this view in Looker is "2756167 Fncb Kingston2 Pathing X Context Report"
view: 2756167_fncb_kingston2_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.2756167_fncb_kingston2_pathing_x_context_report` ;;
