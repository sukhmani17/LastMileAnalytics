# The name of this view in Looker is "3377602 Cibc Birmingham Expanded Cel Cdl Report Cel"
view: 3377602_cibc_birmingham_expanded_cel_cdl_report_cel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3377602_CIBC_Birmingham_expanded_cel_cdl_report_cel` ;;
