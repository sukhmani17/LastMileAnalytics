# The name of this view in Looker is "3414227 Morris Bank Dublin Pathing X Context Report"
view: 3414227_morris_bank_dublin_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3414227_MorrisBank_Dublin_pathing_x_context_report` ;;
