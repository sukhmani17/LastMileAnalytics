# The name of this view in Looker is "3509336 Exchange Bank Gadsden Al Expanded Cel Cdl Report Cel"
view: 3509336_exchange_bank_gadsden_al_expanded_cel_cdl_report_cel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3509336_Exchange_Bank_Gadsden_AL_expanded_cel_cdl_report_cel` ;;
