# The name of this view in Looker is "3376873 United Bankof Michigan Grand Rapids Pathing0 Pathing X Context Report"
view: 3376873_united_bankof_michigan_grand_rapids_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3376873_UnitedBankofMichigan_Grand_Rapids_Pathing-0_pathing_x_context_report` ;;
