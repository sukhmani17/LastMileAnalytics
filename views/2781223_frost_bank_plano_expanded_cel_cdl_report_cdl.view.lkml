# The name of this view in Looker is "2781223 Frost Bank Plano Expanded Cel Cdl Report Cdl"
view: 2781223_frost_bank_plano_expanded_cel_cdl_report_cdl {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.2781223_FrostBank_Plano_expanded_cel_cdl_report_cdl` ;;
