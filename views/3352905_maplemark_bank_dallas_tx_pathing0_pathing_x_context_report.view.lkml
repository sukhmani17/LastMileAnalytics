# The name of this view in Looker is "3352905 Maplemark Bank Dallas Tx Pathing0 Pathing X Context Report"
view: 3352905_maplemark_bank_dallas_tx_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3352905_MaplemarkBank_Dallas_TX_Pathing-0_pathing_x_context_report` ;;
