# The name of this view in Looker is "3027655 Regions Bank Pathing0 Pathing X Context Report"
view: 3027655_regions_bank_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3027655_RegionsBank_Pathing-0_pathing_x_context_report` ;;
