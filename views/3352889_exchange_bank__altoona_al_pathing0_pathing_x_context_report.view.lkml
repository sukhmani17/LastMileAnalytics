# The name of this view in Looker is "3352889 Exchange Bank Altoona Al Pathing0 Pathing X Context Report"
view: 3352889_exchange_bank__altoona_al_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3352889_ExchangeBank__Altoona_AL_Pathing-0_pathing_x_context_report` ;;
