# The name of this view in Looker is "First Peoples Bank Greenville 3393194 Card Project 30493 Vis Card Production Visitor Origin Points Common Evening Location0 Expanded Cel Cdl Report Cel"
view: first_peoples_bank_greenville_3393194_card_project_30493__vis_card_production___visitor_origin_points__common_evening_location0_expanded_cel_cdl_report_cel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.FirstPeoplesBank_Greenville_3393194_CardProject_30493_-_VisCard_production__-_Visitor_Origin_Points_-_Common_Evening_Location-0_expanded_cel_cdl_report_cel` ;;
