# The name of this view in Looker is "First Peoples Bank Greenville 3393192 Card Project 30493 Vis Card Production Pathing0 Pathing X Context Report"
view: first_peoples_bank_greenville_3393192_card_project_30493__vis_card_production___pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.FirstPeoplesBank_Greenville_3393192_CardProject_30493_-_VisCard_production__-_Pathing-0_pathing_x_context_report` ;;
