# The name of this view in Looker is "3028379 Ramsay School Pathing0 Pathing X Context Report"
view: 3028379_ramsay_school_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3028379_RamsaySchool_Pathing-0_pathing_x_context_report` ;;
