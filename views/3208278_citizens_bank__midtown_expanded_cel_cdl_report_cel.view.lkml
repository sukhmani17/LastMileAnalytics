# The name of this view in Looker is "3208278 Citizens Bank Midtown Expanded Cel Cdl Report Cel"
view: 3208278_citizens_bank__midtown_expanded_cel_cdl_report_cel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3208278_CitizensBank__MIDTOWN_expanded_cel_cdl_report_cel` ;;
