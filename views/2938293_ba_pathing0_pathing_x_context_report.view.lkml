# The name of this view in Looker is "2938293 Ba Pathing0 Pathing X Context Report"
view: 2938293_ba_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.2938293_BA_Pathing-0_pathing_x_context_report` ;;
