# The name of this view in Looker is "First Peoples Bank Pine Mountain 3393181 Card Project 30492 Vis Card Production Pathing0 Pathing X Context Report"
view: first_peoples_bank_pine_mountain_3393181_card_project_30492__vis_card_production___pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.FirstPeoplesBank_PineMountain_3393181_CardProject_30492_-_VisCard_production__-_Pathing-0_pathing_x_context_report` ;;
