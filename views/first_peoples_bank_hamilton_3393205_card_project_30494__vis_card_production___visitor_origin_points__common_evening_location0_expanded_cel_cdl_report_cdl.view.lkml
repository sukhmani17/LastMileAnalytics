# The name of this view in Looker is "First Peoples Bank Hamilton 3393205 Card Project 30494 Vis Card Production Visitor Origin Points Common Evening Location0 Expanded Cel Cdl Report Cdl"
view: first_peoples_bank_hamilton_3393205_card_project_30494__vis_card_production___visitor_origin_points__common_evening_location0_expanded_cel_cdl_report_cdl {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.FirstPeoplesBank_Hamilton_3393205_CardProject_30494_-_VisCard_production__-_Visitor_Origin_Points_-_Common_Evening_Location-0_expanded_cel_cdl_report_cdl` ;;
