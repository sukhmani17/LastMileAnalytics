# The name of this view in Looker is "3352907 Maplemark Bank Dallas Tx Expanded Cel Cdl Report Cel"
view: 3352907_maplemark_bank_dallas_tx_expanded_cel_cdl_report_cel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3352907_MaplemarkBank_Dallas_TX_expanded_cel_cdl_report_cel` ;;
