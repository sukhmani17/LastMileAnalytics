# The name of this view in Looker is "3354169 John Marshall Bank Alexandria Va Common Evening Location0 Expanded Cel Cdl Report Cdl"
view: 3354169_john_marshall_bank_alexandria_va_common_evening_location0_expanded_cel_cdl_report_cdl {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3354169_John_Marshall_bank_Alexandria_VA_Common_Evening_Location-0_expanded_cel_cdl_report_cdl` ;;
