# The name of this view in Looker is "First Peoples Bank Hamilton 3393203 Card Project 30494 Vis Card Production Pathing0 Pathing X Context Report"
view: first_peoples_bank_hamilton_3393203_card_project_30494__vis_card_production___pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.FirstPeoplesBank_Hamilton_3393203_CardProject_30494_-_VisCard_production__-_Pathing-0_pathing_x_context_report` ;;
