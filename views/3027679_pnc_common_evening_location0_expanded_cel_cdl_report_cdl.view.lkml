# The name of this view in Looker is "3027679 Pnc Common Evening Location0 Expanded Cel Cdl Report Cdl"
view: 3027679_pnc_common_evening_location0_expanded_cel_cdl_report_cdl {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3027679_PNC_Common_Evening_Location-0_expanded_cel_cdl_report_cdl` ;;
