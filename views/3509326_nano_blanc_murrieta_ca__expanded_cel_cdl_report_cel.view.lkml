# The name of this view in Looker is "3509326 Nano Blanc Murrieta Ca Expanded Cel Cdl Report Cel"
view: 3509326_nano_blanc_murrieta_ca__expanded_cel_cdl_report_cel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3509326_NanoBlanc_Murrieta_CA__expanded_cel_cdl_report_cel` ;;
