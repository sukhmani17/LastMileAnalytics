# The name of this view in Looker is "3474346 First State Bank Mendota Hq Pathing0 Pathing X Context Report"
view: 3474346_first_state_bank__mendota_hq_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3474346_First_State_Bank__Mendota_HQ_Pathing-0_pathing_x_context_report` ;;
