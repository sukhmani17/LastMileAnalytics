# The name of this view in Looker is "3058479 Bankof Missouri Pathing Pathing X Context Report"
view: 3058479_bankof_missouri_pathing_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3058479_BankofMissouri_Pathing_pathing_x_context_report` ;;
