# The name of this view in Looker is "3058481 Bankof Missouri Common Evening Location Expanded Cel Cdl Report Cel"
view: 3058481_bankof_missouri_common_evening_location_expanded_cel_cdl_report_cel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3058481_BankofMissouri_Common_Evening_Location_expanded_cel_cdl_report_cel` ;;
