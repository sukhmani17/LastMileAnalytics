# The name of this view in Looker is "3351186 John Marshall Bank Virginia Expanded Cel Cdl Report Cdl"
view: 3351186_john_marshall_bank_virginia_expanded_cel_cdl_report_cdl {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3351186_John_Marshall_Bank_Virginia_expanded_cel_cdl_report_cdl` ;;
