# The name of this view in Looker is "3354484 Ccornerstone Bank Lexington Pathing0 Pathing X Context Report"
view: 3354484_ccornerstone_bank__lexington_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3354484_CCornerstone bank _Lexington-_Pathing-0_pathing_x_context_report` ;;
