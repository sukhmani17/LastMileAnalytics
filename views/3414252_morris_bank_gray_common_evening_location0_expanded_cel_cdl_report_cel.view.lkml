# The name of this view in Looker is "3414252 Morris Bank Gray Common Evening Location0 Expanded Cel Cdl Report Cel"
view: 3414252_morris_bank_gray_common_evening_location0_expanded_cel_cdl_report_cel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3414252_MorrisBank_Gray_Common_Evening_Location-0_expanded_cel_cdl_report_cel` ;;
  ...
  measure: total_common_evening_distance_mi {
    type: sum
    sql: ${common_evening_distance_mi} ;;  }
  measure: average_common_evening_distance_mi {
    type: average
    sql: ${common_evening_distance_mi} ;;  }
