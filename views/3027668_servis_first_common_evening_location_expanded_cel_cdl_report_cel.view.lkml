# The name of this view in Looker is "3027668 Servis First Common Evening Location Expanded Cel Cdl Report Cel"
view: 3027668_servis_first_common_evening_location_expanded_cel_cdl_report_cel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3027668_ServisFirst_Common_Evening_Location_expanded_cel_cdl_report_cel` ;;
