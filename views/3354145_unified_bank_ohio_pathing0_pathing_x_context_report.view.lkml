# The name of this view in Looker is "3354145 Unified Bank Ohio Pathing0 Pathing X Context Report"
view: 3354145_unified_bank_ohio_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3354145_UnifiedBank_Ohio_Pathing-0_pathing_x_context_report` ;;
