# The name of this view in Looker is "3351184 John Marshall Bank Virginia Pathing0 Pathing X Context Report"
view: 3351184_john_marshall_bank_virginia_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3351184_John_Marshall_Bank_Virginia_Pathing-0_pathing_x_context_report` ;;
