# The name of this view in Looker is "3208267 Citizens Bank Edmond Pathing X Context Report"
view: 3208267_citizens_bank_edmond_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3208267_CitizensBank_EDMOND_pathing_x_context_report` ;;
