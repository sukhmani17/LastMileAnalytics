# The name of this view in Looker is "First Peoples Bank Pine Mountain 3393183 Card Project 30492 Vis Card Production Visitor Origin Points Common Evening Location0 Expanded Cel Cdl Report Cdl"
view: first_peoples_bank_pine_mountain_3393183_card_project_30492__vis_card_production___visitor_origin_points__common_evening_location0_expanded_cel_cdl_report_cdl {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.FirstPeoplesBank_PineMountain_3393183_CardProject_30492_-_VisCard_production__-_Visitor_Origin_Points_-_Common_Evening_Location-0_expanded_cel_cdl_report_cdl` ;;
  ...
  measure: total_common_daytime_census {
    type: sum
    sql: ${common_daytime_census} ;;  }
  measure: average_common_daytime_census {
    type: average
    sql: ${common_daytime_census} ;;  }
