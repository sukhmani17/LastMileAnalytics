# The name of this view in Looker is "2781731 Frost Bank2 Coppell Pathing X Context Report"
view: 2781731_frost_bank2_coppell_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.2781731_FrostBank2_Coppell_pathing_x_context_report` ;;
