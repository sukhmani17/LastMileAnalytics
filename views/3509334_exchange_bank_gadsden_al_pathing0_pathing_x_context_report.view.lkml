# The name of this view in Looker is "3509334 Exchange Bank Gadsden Al Pathing0 Pathing X Context Report"
view: 3509334_exchange_bank_gadsden_al_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3509334_Exchange_Bank_Gadsden_AL_Pathing-0_pathing_x_context_report` ;;
