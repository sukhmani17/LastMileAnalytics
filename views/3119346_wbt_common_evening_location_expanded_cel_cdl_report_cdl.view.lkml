# The name of this view in Looker is "3119346 Wbt Common Evening Location Expanded Cel Cdl Report Cdl"
view: 3119346_wbt_common_evening_location_expanded_cel_cdl_report_cdl {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3119346_WBT_Common_Evening_Location_expanded_cel_cdl_report_cdl` ;;
