# The name of this view in Looker is "3361062 First Capital Bank Texas Wichita Falls Common Evening Location Expanded Cel Cdl Report Cel"
view: 3361062_first_capital_bank_texas_wichita_falls_common_evening_location_expanded_cel_cdl_report_cel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3361062_FirstCapitalBank_Texas_WichitaFalls_Common_Evening_Location-_expanded_cel_cdl_report_cel` ;;
