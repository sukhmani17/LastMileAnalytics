# The name of this view in Looker is "3377600 Cibc Birmingham Pathing0 Pathing X Context Report"
view: 3377600_cibc_birmingham_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3377600_CIBC_Birmingham_Pathing-0_pathing_x_context_report` ;;
