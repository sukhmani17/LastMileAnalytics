# The name of this view in Looker is "Progressbank Pathing2096993"
view: progressbank_pathing2096993 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.progressbank_pathing2096993` ;;
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # This dimension will be called " Study Polygon" in Explore.

  dimension: _study_polygon {
    type: string
    sql: ${TABLE}._Study_Polygon ;;
  }
