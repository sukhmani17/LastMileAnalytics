# The name of this view in Looker is "3027909 Grid1 Pathing X Context Report"
view: 3027909_grid1_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3027909_Grid1_pathing_x_context_report` ;;
