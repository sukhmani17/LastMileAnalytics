# The name of this view in Looker is "3361060 First Capital Bank Texas Wichita Falls Pathing0 Pathing X Context Report"
view: 3361060_first_capital_bank_texas_wichita_falls_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3361060_FirstCapitalBank_Texas_WichitaFalls_Pathing-0_pathing_x_context_report` ;;
