# The name of this view in Looker is "3474358 First State Bank Monticello Common Evening Location0 Expanded Cel Cdl Report Cdl"
view: 3474358_first_state_bank_monticello_common_evening_location0_expanded_cel_cdl_report_cdl {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3474358_First_State_Bank_Monticello_Common_Evening_Location-0_expanded_cel_cdl_report_cdl` ;;
