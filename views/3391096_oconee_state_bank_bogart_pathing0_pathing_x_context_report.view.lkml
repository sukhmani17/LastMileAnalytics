# The name of this view in Looker is "3391096 Oconee State Bank Bogart Pathing0 Pathing X Context Report"
view: 3391096_oconee_state_bank_bogart_pathing0_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3391096_Oconee_State_Bank_Bogart_Pathing-0_pathing_x_context_report` ;;
