# The name of this view in Looker is "3509326 Nano Blanc Murrieta Ca Expanded Cel Cdl Report Cdl"
view: 3509326_nano_blanc_murrieta_ca_expanded_cel_cdl_report_cdl {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3509326_NanoBlanc_Murrieta_CA_expanded_cel_cdl_report_cdl` ;;
