# The name of this view in Looker is "3352891 Exchange Bank Altoona Al Common Daytime Location0 Expanded Cel Cdl Report Cel"
view: 3352891_exchange_bank__altoona_al_common_daytime_location0_expanded_cel_cdl_report_cel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3352891_ExchangeBank__Altoona_AL_Common_Daytime_Location-0_expanded_cel_cdl_report_cel` ;;
