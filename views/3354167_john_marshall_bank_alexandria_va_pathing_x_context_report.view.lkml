# The name of this view in Looker is "3354167 John Marshall Bank Alexandria Va Pathing X Context Report"
view: 3354167_john_marshall_bank_alexandria_va_pathing_x_context_report {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `Vista_footfall.3354167_John_Marshall_bank_Alexandria_VA_pathing_x_context_report` ;;
